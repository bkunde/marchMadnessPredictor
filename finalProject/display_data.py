...
def display_feature_histograms(my_args, data, figure_number):
    ...
    fig = plt.figure(figure_number, figsize=(39, 36))
    ...
    if file_name == "": 
        ...
        figure_name = "{}-histogram-{}.{}".format(basename, file_name, "pdf")
...
def display_label_vs_features(my_args, data, figure_number):
    ...
    if file_name == "":
        ...
        figure_name = "{}-scatter-{}.{}".format(basename, file_name, "pdf")
    fig.savefig(figure_name)
    plt.close(fig)
...
def parse_args(argv):
    ...
    parser.add_argument('--file-name',           '-n', default="",    type=str,   help="name for file of plots")
